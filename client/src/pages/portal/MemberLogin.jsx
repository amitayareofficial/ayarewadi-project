...
export default function MemberLogin({ onGoRegister, onGoForgot, onLoginSuccess, lang = "mr" }) {
  ...
  const handleLogin = async e => {
    ...
    try {
      ...
      setError(err.response?.data?.error || (lang === "mr" ? "लॉगिन अयशस्वी. पुन्हा प्रयत्न करा." : "Login failed. Please try again."));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <section className="portal-page flex min-h-screen w-full">
      ...
      <div className="w-full lg:w-1/2 flex flex-col bg-white flex-1">
        ...
        {/* Form area */}
        <div className="portal-form-area flex-1 flex flex-col lg:justify-center items-center px-4 sm:px-8 lg:px-12 py-6 lg:py-12">
          <div className="w-full max-w-md">
            ...
            <BoxReveal boxColor="var(--skeleton)" duration={0.3} className="mb-1">
              <h2 className="font-black text-2xl sm:text-3xl text-neutral-800">{t.greeting}</h2>
            </BoxReveal>
            <BoxReveal boxColor="var(--skeleton)" duration={0.3} className="mb-7">
